...
/**
 * Placeholder singleton that will be passed to [ViewHolder.bind] methods for placeholder item type.
 *
 * @see PagedAdapter.BuilderStageFinal.withPlaceholderType
 * @see PagedAdapter.BuilderStageFinal.withSimplePlaceholderType
 */
object Placeholder