...
private const val KEY_STRING_KEYS = "com.github.iojjj.bootstrap.adapters.selection.keys.STRING_KEYS"

class StringKeysBundler : Bundler<Collection<String>> {

    override fun read(bundle: Bundle): Collection<String>? = bundle.getStringArrayList(
            KEY_STRING_KEYS)
